...
def main():
    print("Starting 3D Fullres Validation Inference...")
    ...
    model_folder = join(os.environ['nnUNet_results'], 'Dataset001_CardiacSeg', 'nnUNetTrainer__nnUNetPlans__3d_fullres')
    ...
    # Output directory
    output_dir = r'C:\CardiacSeg\inference_3d_fullres_validation'
