...
def main():
    print("Starting 2D Validation Inference...")
    ...
    model_folder = join(os.environ['nnUNet_results'], 'Dataset001_CardiacSeg', 'nnUNetTrainer__nnUNetPlans__2d')
    ...
    # Output directory
    output_dir = r'C:\CardiacSeg\inference_2d_validation_final'
